...
#egostart = pyoscx.TeleportAction(pyoscx.WorldPosition(-9.4,-152.8,0.5,1.57079632679))
egostart = pyoscx.TeleportAction(pyoscx.WorldPosition(-8.6,90,0.5,4.7))
...
#autopilot adversary
apa_starttrigger = pyoscx.ValueTrigger('StartCondition',1,pyoscx.ConditionEdge.rising,pyoscx.SimulationTimeCondition(0,pyoscx.Rule.greaterThan))
apa_eventstart = pyoscx.Event('StartAutopilot',pyoscx.Priority.overwrite)
apa_eventstart.add_trigger(apa_starttrigger)
apa_actionstart = pyoscx.ActivateControllerAction(True,True)
...
sp_eventstart = pyoscx.Event('StartSpeed',pyoscx.Priority.overwrite)
...
sp_action = pyoscx.AbsoluteSpeedAction(10,sp_sin_time)
sp_event.add_action('newspeed',sp_action)


#change lane
cl_trigcond = pyoscx.RelativeDistanceCondition(40,pyoscx.Rule.lessThan, pyoscx.RelativeDistanceType.cartesianDistance,targetname,freespace=False)
...
#autopilot
ap_trigcond = pyoscx.RelativeDistanceCondition(5,pyoscx.Rule.lessThan, pyoscx.RelativeDistanceType.cartesianDistance,targetname,freespace=False)
ap_starttrigger = pyoscx.EntityTrigger('distancetrigger',1,pyoscx.ConditionEdge.none,ap_trigcond,egoname)
