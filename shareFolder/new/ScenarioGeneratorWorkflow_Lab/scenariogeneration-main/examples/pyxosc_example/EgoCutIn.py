...
trigcond = pyoscx.RelativeDistanceCondition(8,pyoscx.Rule.lessThan, pyoscx.RelativeDistanceType.cartesianDistance,targetname,freespace=False)
...
action = pyoscx.RelativeLaneChangeAction(2,targetname,sin_time)
...
## create the scenario
sce = pyoscx.Scenario('ego_cut_in','Bonora_Motta',paramdec,entities=entities,storyboard = sb,roadnetwork=road,catalog=catalog)

# display the scenario
pyoscx.prettyprint(sce.get_element())

# if you want to save it
sce.write_xml('EgoCutIn.xosc',True)
