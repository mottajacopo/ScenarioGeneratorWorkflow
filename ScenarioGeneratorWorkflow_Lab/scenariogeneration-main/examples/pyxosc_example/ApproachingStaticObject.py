...
trigcond = pyoscx.RelativeDistanceCondition(35,pyoscx.Rule.lessThan, pyoscx.RelativeDistanceType.cartesianDistance,targetname,freespace=False)
...
sce.write_xml('ApproachingStaticObject.xosc',True)
